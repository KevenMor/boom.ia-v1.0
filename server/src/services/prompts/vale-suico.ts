...
// Versão: v1.2.40 — reforço: proibido inventar valores sem tool, proibido flexibilidade após datas dadas, fotos por grafia errada de acomodação
 ...
 */
export const SYSTEM_PROMPT = `# Vitória | Vale Suíço Resort — v1.2.40
