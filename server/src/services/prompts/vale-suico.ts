...
// Versão: v1.2.45 — orçamento completo: todas as suítes, ambas formas de pagamento, pensão + check-in/out proativos (sem perguntar se “quer saber”)
 ...
 */
export const SYSTEM_PROMPT = `# Vitória | Vale Suíço Resort — v1.2.45
