...
- TRANSFERÊNCIA — ALUNO EXISTENTE: Quando a última mensagem do assistente disser que vai encaminhar, transferir ou passar para o time/equipe da unidade E o cliente informou em qual unidade está matriculado: chame atribuir_agente com reason = nome canônico. Mapeamento: coop / zona norte → "Coop Zona Norte"; vila haro → "Vila Haro"; vila helena → "Vila Helena"; júlio de mesquita / julio → "Júlio de Mesquita"; aparecidinha / aparecida → "Aparecidinha". NUNCA chame consultar_cep nem nearest_unit neste fluxo — o cliente não informou CEP.
