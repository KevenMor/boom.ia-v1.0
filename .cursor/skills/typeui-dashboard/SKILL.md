...
description: >-
  Dark-themed cloud-platform aesthetic (TypeUI): modular grids, glass-like
  panels, data hierarchy, WCAG 2.2 AA, 8pt grid. Use ao desenhar ou rever
  dashboards e métricas no Boom IA.
license: MIT
metadata:
  author: typeui.sh
---
