...
export const providerModels: Record<string, { label: string; models: { value: string; label: string; description: string }[] }> = {
  "Google Gemini": {
    ...
    models: [
      ...
      { value: "gemini-2.5-pro", label: "Gemini 2.5 Pro", description: "Thinking model mais avançado" },
  ...
  OpenAI: {
    ...
    models: [
      ...
      { value: "gpt-4", label: "GPT-4", description: "Modelo base GPT-4" },
      { value: "gpt-3.5-turbo", label: "GPT-3.5 Turbo", description: "Rápido e muito barato" },
      { value: "o1", label: "o1", description: "Raciocínio avançado" },
      { value: "o1-mini", label: "o1 Mini", description: "Raciocínio rápido" },
      { value: "o1-pro", label: "o1 Pro", description: "Raciocínio máximo" },
      { value: "o3", label: "o3", description: "Raciocínio de última geração" },
      { value: "o3-mini", label: "o3 Mini", description: "Raciocínio eficiente" },
      { value: "o4-mini", label: "o4 Mini", description: "Raciocínio compacto e rápido" },
      { value: "gpt-4.1", label: "GPT-4.1", description: "Coding e instruções longas" },
      { value: "gpt-4.1-mini", label: "GPT-4.1 Mini", description: "Equilíbrio custo/qualidade" },
      { value: "gpt-4.1-nano", label: "GPT-4.1 Nano", description: "Ultra rápido e barato" },
      { value: "gpt-4.5-preview", label: "GPT-4.5 Preview", description: "Criativo e conversacional" },
    ],
  },
  Anthropic: {
    label: "Anthropic",
