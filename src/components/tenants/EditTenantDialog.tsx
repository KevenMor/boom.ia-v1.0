  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Editar Tenant</DialogTitle>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pt-2">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Label className="text-sm font-medium text-muted-foreground">Tool Dispatcher (Provider)</Label>
              <Badge variant="secondary" className="text-[10px]">Fase 1</Badge>
            </div>
            <p className="text-xs text-muted-foreground">Provider usado para decidir quando acionar ferramentas</p>
            <Select
          ...
          <div className="space-y-1">
            <h4 className="text-base font-semibold text-foreground">Configuração LLM</h4>
            <p className="text-sm text-muted-foreground">Parâmetros de geração para os agentes deste tenant</p>
          </div>
          ...
          <DialogFooter className="gap-3 pt-2">
            ...
            <Button type="submit" disabled={updateTenant.isPending} className="h-11 rounded-lg px-6">
              {updateTenant.isPending && <div className="mr-2 h-3 w-3 animate-spin rounded-full border-2 border-primary-foreground border-t-transparent" />}
              Salvar
            </Button>
          </DialogFooter>
        </form>
