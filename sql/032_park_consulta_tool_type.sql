-- Boom IA — Permite tool_type park_consulta na tabela public.tools
-- Pré-requisito para registrar consultar_parque_sunset (sql/033).
...
ALTER TABLE public.tools
  ...
  CHECK (tool_type IN (
    ...
    'lodging_consulta', 'artaxnet_availability', 'park_consulta'
  ));
